...
class ScanResultPage extends StatefulWidget {
  ...
  final String? message; // optional pesan dari callback
...
class _ScanResultPageState extends State<ScanResultPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final statusText = widget.isApproved ? "Approved" : "Rejected";
    final statusColor = widget.isApproved ? Colors.green : Colors.red;
    final statusIcon = widget.isApproved ? Icons.check_circle : Icons.cancel;
                                  ...
                                  child: Image.network(
                                    widget.userData["sim_url"].startsWith("http")
                                        ...
                                        : Supabase.instance.client.storage
                                            .from("siswa")
                                            .getPublicUrl(widget.userData["sim_url"]),
                                    fit: BoxFit.cover,
                                  ),
                                ),
                              )
